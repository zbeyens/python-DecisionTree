...
def test_tree(tree, classes, target, dataset):
    ...
    print("Successful Frauds detection:", int(
        round(frauds_correct / frauds_total * 100)), "%")
    print("Successful Legit detection:", int(
...
if __name__ == "__main__":
    ...
    attributes, validation_set_extended = parse_credits(
    ...
    test_tree(undersampled.tree, attributes,
              "Class", validation_set_undersampled)
